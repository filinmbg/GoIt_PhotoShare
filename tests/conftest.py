...
test_user = {"username": "sasha1", "email": "sasha1@example.com", "password": "12345678"}
...
def init_models_wrap():
    async def init_models():
        ...
        async with TestingSessionLocal() as session:
            ...
            current_user = User(username=test_user["username"], email=test_user["email"], password=hash_password, avatar="")
